...
public class HelpCommand extends Command {
	...
	public HelpCommand(String labelIn)
	{
		super(labelIn);
	}
	...
	public void fireInGuild(String[] args, User sender, TextChannel channel)
	{
		...
		for(Command cmd : CommandRegistry.getAll())
		{
			...
			MessageHandler.sendMsgGuild(channel,"   " +  Main.PREFIX + cmd.getLabel());
		}
	}
	...
	public void fireInPrivate(String[] args, User sender, PrivateChannel channel)
	{
		...
		for(Command cmd : CommandRegistry.getAll())
		{
			...
			MessageHandler.sendMsgPrivate(channel,"   " + Main.PREFIX + cmd.getLabel());
		}
	}
	...
	public void fireInConsole(String[] args)
	{
		...
		for(Command cmd: CommandRegistry.getAll())
		{
			...
			System.out.println("   " + Main.PREFIX + cmd.getLabel());
		}
	}
}
